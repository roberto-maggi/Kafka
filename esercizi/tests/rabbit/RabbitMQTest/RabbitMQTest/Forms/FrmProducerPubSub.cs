...
{
    public partial class FrmProducerPubSub : Form
    {
        private int _countMessage = 0;
        private string _instanceName;

        public FrmProducerPubSub()
        {
            InitializeComponent();
        }

        public FrmProducerPubSub(int instance) : this()
        {
        ...
        private void SendMessage()
        {
            ...
            using (var channel = connection.CreateModel())
            {
                ...
                for (int count = 0; count < 1000; count++) {
                    ...
                    string message = "Message Pub/Sub Nr " + _countMessage;
