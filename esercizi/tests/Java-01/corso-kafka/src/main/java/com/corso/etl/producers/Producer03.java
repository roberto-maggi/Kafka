...
public class Producer03 extends ProducerBase  {
	...
	public void sendSync() {
		...
		// Client ID
		props.put(ProducerConfig.CLIENT_ID_CONFIG, "P03");
		...
		System.out.println("START P03 -> " + formatter.format(new Date()));
		...
		System.out.println("END P03 -> " + formatter.format(new Date()));
