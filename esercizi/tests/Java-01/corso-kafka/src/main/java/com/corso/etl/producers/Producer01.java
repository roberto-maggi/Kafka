...
public class Producer01 {
	...
	// FIRE & FORGET ACK = 0
	public void sendMessagesFireAndForget() {
		...
		System.out.println("START P01 -> " + formatter.format(new Date()));
		for (int count = 0; count < 10000000; count++) {
			record = new ProducerRecord<String, String>("TP_01", "Messagio Nr" + count);
			try {
		...
		System.out.println("END P01 -> " + formatter.format(new Date()));
